...
export default [
  // 1) Ignored files (replaces .eslintignore)
  {
    ignores: [
      ...
      '**/ios/**',
      '**/flutter/**',
      '**/tests/performance/visualize-results.js',
      '**/.gradle/**',
      '**/Pods/**',
      '**/.dart_tool/**',
      '**/web/**/*.js',
      ...
      '.docs/**',
      // Performance tests
      'packages/tests/performance/**',
      // Generated OpenAPI files
      'packages/api/generated/openapi/**',
    ],
  },
  ...
  // 6) Security overrides for cache files with false positives
  {
    files: [
      'packages/redis/src/infrastructure/cache/keygen.ts',
      'packages/redis/src/infrastructure/services/memory.ts',
    ],
    rules: {
